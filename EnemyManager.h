...
public :
    ...
    Uint64 get_time_appear_bat() const {return time_appear_bat;}
    Uint64 get_time_appear_wolf() const {return time_appear_wolf;}
    void set_time_appear_bat(const Uint64 time_appear_bat_) {time_appear_bat = time_appear_bat_;}
    void set_time_appear_wolf(const Uint64 time_appear_wolf_) {time_appear_wolf = time_appear_wolf_;}
